...
<head>
<title>View Content Attackers</title>
	...
	{		
				%>
                    <tr>
                      ...
                      <td width="111" bgcolor="#FF0000"><div align="center" class="style27"> File Name </div></td>
                      <td width="131" bgcolor="#FF0000"><div align="center" class="style27">Attacker Type </div></td>
                      <td width="153" bgcolor="#FF0000"><div align="center" class="style27">Date and Time </div></td>
                    </tr>
                    <%
				
				String query1="Select * from attacker1   "; 
				...
				while ( rs1.next()==true )
				{
                    ...
                    <tr>
                      ...
                      <td><div align="center" class="style29"><%=s1%></div></td>
