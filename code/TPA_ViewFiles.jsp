...
try 
	{		
				%>
                    <tr>
                      <td width="53" height="30" bgcolor="#FF0000"><div align="center" class="style25 style26"> ID </div></td>
                      <td width="88" bgcolor="#FF0000"><div align="center" class="style27">File Name </div></td>
					  <td width="119" bgcolor="#FF0000"><div align="center" class="style27">Trapdoor </div></td>
                      <td width="149" bgcolor="#FF0000"><div align="center" class="style27">Date &amp; Time </div></td>
                      <td width="116" bgcolor="#FF0000"><div align="center" class="style27">Data Owner </div></td>
                    </tr>
                    <%
				
				String query1="Select * from tpadata"; 
...
%>
            ...
            <div class="col-2">
			<ul>
				<li><a href="TPA_Main.jsp">Home</a></li>
				<li><a href="TPA_Login.jsp">Logout</a></li>
			</ul>
            </div>
          </div>
        </div>
