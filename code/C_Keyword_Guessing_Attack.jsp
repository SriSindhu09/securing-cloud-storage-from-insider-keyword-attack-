...
<head>
<title>C_Keyword_Guessing_Attack</title>
...
<div class="tail-top">
  <div class="tail-bottom">
        ...
        <div class="tail-right">
          <div class="wrapper">
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>View Keyword Guessing Attack !!! </h3>
                  <p align="justify">&nbsp;</p>
                  <table width="763" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
                    <tr>
                      ...
                      <td width="146" bgcolor="#FF0000"><div align="center" class="style24">Guessing Keyword </div></td>
      	...
      	try 
	{
      		...
      		String query="select * from keyword_guessing_attack "; 
